                            ...
                            <Col xs="12">
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardTitle> <strong>Add New Product </strong></CardTitle>
                                        ...
                                        <Form>
                                            <Row>
                                                <Col sm="6">
                                                    <FormGroup>
                                                        <Input id="productname" name="productname" type="text" placeholder="Product Name" className="form-control" />
                                                    </FormGroup>
                                                    <FormGroup>
                                                        <Input id="manufacturername" name="manufacturername" type="text" placeholder="Manufacturer Name" className="form-control" />
                                                    </FormGroup>
                                                    <FormGroup>
                                                        <Input id="manufacturerbrand" name="manufacturerbrand" type="text" placeholder="Manufacturer Brand" className="form-control" />
                                                    </FormGroup>
                                                    <FormGroup>
